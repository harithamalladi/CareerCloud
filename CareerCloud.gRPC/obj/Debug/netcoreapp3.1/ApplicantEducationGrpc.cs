...
namespace CareerCloud.gRPC.Protos {
  public static partial class ApplicantEducationService
  {
    ...
    static readonly grpc::Method<global::CareerCloud.gRPC.Protos.ApplicantEducations, global::Google.Protobuf.WellKnownTypes.Empty> __Method_UpdateApplcantEducation = new grpc::Method<global::CareerCloud.gRPC.Protos.ApplicantEducations, global::Google.Protobuf.WellKnownTypes.Empty>(
        grpc::MethodType.Unary,
        __ServiceName,
    ...
    static readonly grpc::Method<global::CareerCloud.gRPC.Protos.ApplicantEducations, global::Google.Protobuf.WellKnownTypes.Empty> __Method_DeleteApplcantEducation = new grpc::Method<global::CareerCloud.gRPC.Protos.ApplicantEducations, global::Google.Protobuf.WellKnownTypes.Empty>(
        grpc::MethodType.Unary,
        __ServiceName,
    ...
    public abstract partial class ApplicantEducationServiceBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::Google.Protobuf.WellKnownTypes.Empty> UpdateApplcantEducation(global::CareerCloud.gRPC.Protos.ApplicantEducations request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }

      public virtual global::System.Threading.Tasks.Task<global::Google.Protobuf.WellKnownTypes.Empty> DeleteApplcantEducation(global::CareerCloud.gRPC.Protos.ApplicantEducations request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, ApplicantEducationServiceBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_UpdateApplcantEducation, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::CareerCloud.gRPC.Protos.ApplicantEducations, global::Google.Protobuf.WellKnownTypes.Empty>(serviceImpl.UpdateApplcantEducation));
      serviceBinder.AddMethod(__Method_DeleteApplcantEducation, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::CareerCloud.gRPC.Protos.ApplicantEducations, global::Google.Protobuf.WellKnownTypes.Empty>(serviceImpl.DeleteApplcantEducation));
    }
